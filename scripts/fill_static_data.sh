...
DB_NAME="team05"
DB_USER="team05"
DROP_SCRIPT="../database/seeds/dev/clean_db.sql"
...
echo "Initializing db static data loading process: $DB_NAME"

for file in ../database/seeds/static/*.sql; do
    echo "Running: $file"
...
trap - ERR
unset MYSQL_PWD
echo "Static data loaded succesfully created successfully"
